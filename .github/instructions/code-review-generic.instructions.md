...
This project is a .NET 8 WPF desktop application (SysOps Commander) for cybersecurity operations:

- **Tech Stack**: C# 12, .NET 8, WPF, CommunityToolkit.Mvvm, SQLite/Dapper, Serilog, PowerShell SDK
- **Architecture**: MVVM with service layer, DI via Microsoft.Extensions.DependencyInjection
- **Testing**: xUnit + NSubstitute + FluentAssertions
- **Code Style**: SOLID principles, interface-first development, XML documentation on all public members
